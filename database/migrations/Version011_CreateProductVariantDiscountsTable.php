...
class Version011_CreateProductVariantDiscountsTable extends AbstractMigration
{
    ...
    */
    ...
    {
        return 'Create product_variant_discounts table';
    }

    /**
     * Apply the migration (create the product_variant_discounts table).
     *
     * @param Schema $schema
     *
     * @return void
    */
    ...
    /**
     * Reverse the migration (drop the product_variant_discounts table).
     *
     * @param Schema $schema
     *
     * @return void
